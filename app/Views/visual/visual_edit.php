                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-12">
                                <form action="<?= base_url('admin/visual/update')?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="">Link Visual Tableau</label>
                                        <textarea class="form-control <?= ($validation->hasError('link_visual') ? 'is-invalid' : '')?>" id="" name="link_visual" rows="3" placeholder="Link share tableau><?= $visual[0]->link_visual?></textarea>
                                        <div class="invalid-feedback">
                                            <?= $validation->getError('link_visual')?>
                                        </div>
                                    </div>
