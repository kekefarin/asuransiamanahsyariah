                            ...
                            <div class="col-12">
                                <form action="<?= base_url('user/dataset/store')?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('nama_dataset') ? 'is-invalid' : '')?>" id="" name="nama_dataset" placeholder="Nama Dataset">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control <?= ($validation->hasError('deskripsi') ? 'is-invalid' : '')?>" id="" name="deskripsi" rows="3" placeholder="Deskripsi tentang dataset yang diupload"></textarea>
                                        <div class="invalid-feedback">
