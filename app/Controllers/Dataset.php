...
class Dataset extends BaseController
{
    ...
    public function store()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if (!$this->validate($rules)) {
                ...
                if ($cek && $cekvisual){
                    session()->setFlashdata(['type' => 'alert-success', 'pesan' => 'Dataset berhasil ditambah']);
                    return redirect()->to(base_url('user/dataset'));
                }else{
                    session()->setFlashdata(['type' => 'alert-danger', 'pesan' => ' Dataset gagal ditambah']);
                    return redirect()->to(base_url('user/dataset'));
                }     
            }
        }
    ...
    public function update()
    {
        ...
        if ($this->request->getFile('file_dataset')->getName() == "") {
            ...
            if (!$this->validate($rules)) {
                ...
                if ($cek){
                    session()->setFlashdata(['type' => 'alert-success', 'pesan' => 'Dataset berhasil dirubah']);
                    return redirect()->to(base_url('user/dataset'));
                }else{
                    session()->setFlashdata(['type' => 'alert-danger', 'pesan' => 'Dataset gagal dirubah']);
                    return redirect()->to(base_url('user/dataset'));
                }     
            }
        }
    ...
    public function hapus($id = null)
    {
        ...
        if ($cek && $cek_visual){
            session()->setFlashdata(['type' => 'alert-success', 'pesan' => 'Dataset berhasil dihapus']);
            return redirect()->to(base_url('user/dataset'));
        }else{
            session()->setFlashdata(['type' => 'alert-danger', 'pesan' => 'Dataset gagal dihapus']);
            return redirect()->to(base_url('user/dataset'));
        } 
    }
