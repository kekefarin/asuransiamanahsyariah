...
class Visual extends BaseController
{
        ...
        if ($this->request->is('post')) {
            ...
            if (!$this->validate($rules)) {
                ...
                if ($cek && $cekdataset){
                    ...
                    session()->setFlashdata(['type' => 'alert-danger', 'pesan' => 'Dataset gagal diupload']);
                    return redirect()->to(base_url('admin/visual'));
                }     
            }
        }
    ...
    {   
        ...
        if ($view == "pdf") {
            ...
            return view('visual/visual_tableau', ['file' => $data['link_visual']]);
        }
    }
        ...
        if ($this->request->getFile('file_visual')->getName() == "") {
            ...
            if (!$this->validate($rules)) {
                ...
                if ($cek){
                    ...
                    session()->setFlashdata(['type' => 'alert-danger', 'pesan' => 'Dataset gagal diedit']);
                    return redirect()->to(base_url('admin/visual'));
                }  
